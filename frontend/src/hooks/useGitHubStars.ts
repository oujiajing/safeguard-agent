...
const REPOSITORY_API_URL = "https://api.github.com/repos/oujiajing/safeguard-agent";
const STAR_CACHE_KEY = "safeguard-agent.github-stars";
const LEGACY_STAR_CACHE_KEY = "safeguard-agent.legacy.github-stars";
