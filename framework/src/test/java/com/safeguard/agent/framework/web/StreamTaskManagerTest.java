package com.safeguard.agent.framework.web;
...
class StreamTaskManagerTest {
    ...
    private static final String CANCEL_TOPIC = "safeguard:stream:cancel";
    private static final String CANCEL_KEY = "safeguard:stream:cancel:" + TASK_ID;
    private static final String OWNER_KEY = "safeguard:stream:owner:" + TASK_ID;
