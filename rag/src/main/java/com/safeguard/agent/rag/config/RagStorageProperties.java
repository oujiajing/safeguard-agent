...
public class RagStorageProperties {
     ...
     */
    private String kbBucket = "safeguard-sources";

    /**
     * 多模态资产桶：PDF 抽出的图片等，公共读，供浏览器匿名直连预览
     */
    private String assetBucket = "safeguard-assets";
    ...
    public static class Oss {
        ...
        /**
         * 资产公开访问基址（虚拟主机式，已含 bucket 子域），如 <a href="https://safeguard-assets.oss-cn-hangzhou.aliyuncs.com">...</a>
         */
        private String publicUrl;
    }
}
