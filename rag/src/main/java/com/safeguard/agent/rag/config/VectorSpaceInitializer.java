...
@Slf4j
@Component
@ConditionalOnProperty(prefix = "rag.vector", name = "initialize-on-startup", havingValue = "true", matchIfMissing = true)
@RequiredArgsConstructor
public class VectorSpaceInitializer {

    private static final String LOCK_KEY_PREFIX = "safeguard:vector:space:init:";
