package com.safeguard.agent.user.service.impl;
...
import com.safeguard.agent.user.enums.UserRole;
import com.safeguard.agent.user.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    @LogRecord(
            ...
            type = BizChangeBizType.USER,
            subType = BizChangeOperationType.UPDATE,
            bizNo = "{{T(com.safeguard.agent.framework.context.UserContext).getUserId()}}",
            extra = BizChangeLogContext.SNAPSHOT_EXPRESSION,
            condition = BizChangeLogContext.RECORD_CONDITION
    )
